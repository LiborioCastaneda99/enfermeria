...
<head>
    ...
    <title>Inicio | 3NNN Diagnostic</title>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                <h3> 
                                    <span>3NNN Diagnostic</span>
                                </h3>
                                <form action="#">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <p style="margin-bottom: 10px;">¡Busca tu diagnóstico aquí!</p>
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder='Encontrar diagnósticos'
                                                    onfocus="this.placeholder = ''"
                                                    onblur="this.placeholder = 'Encontrar diagnósticos'">
                                                <div class="input-group-append">
                                                    <button class="btn" type="button"><i class="ti-search"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="submit" class="boxed-btn3 genric-btn" value="Buscar">
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-md-6">
                    <div class="single_service">
                        ...
                        <a href="#" class="boxed-btn3-white">Solicitar</a>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                    <div class="single_service">
                        ...
                        <p>La excelencia clínica debe ser la prioridad para cualquier proveedor de servicios de atención médica.</p>
                        <a href="tel:+573046203681" class="boxed-btn3-white">+573046203681</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="welcome_docmed_info">
                        <h2>Bienvenidos a 3NNN Diagnostic</h2>
                        <h3>La mejor atención para su buena salud</h3>
                        ...
                        <div class="expert_active owl-carousel">
                            <div class="single_expert">
                                ...
                                <div class="experts_name text-center">
                                    <h3>Melissa Paola Escaño Padilla</h3>
                                    <span>Estudiante de enfermería de séptimo semestre de la Universidad del Norte</span>
                                </div>
                            </div>
                            <div class="single_expert">
                                <div class="expert_thumb">
                                ...
                                <div class="experts_name text-center">
                                    <h3>Omar Yesid Barrios Castro</h3>
                                    <span>Estudiante de enfermería de séptimo semestre de la Universidad del Norte</span>
                                </div>
                            </div>
                            <div class="single_expert">
                                ...
                                <div class="experts_name text-center">
                                    <h3>Anthony Manuel Pérez Ramírez</h3>
                                    <span>Estudiante de enfermería de séptimo semestre de la Universidad del Norte</span>
                                </div>
                            </div>
                            <div class="single_expert">
                                ...
                                <div class="experts_name text-center">
                                    <h3>Jessica Alejandra Mendoza Martínez</h3>
                                    <span>Estudiante de enfermería de séptimo semestre de la Universidad del Norte</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6">
                    <div class="single_emergency d-flex align-items-center justify-content-center emergency_bg_1 overlay_skyblue">
                        <div class="info">
                            <h3>Para cualquier contacto de emergencia</h3>
                            <p>Estima el temperamento del espíritu también di adiós.</p>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="single_emergency d-flex align-items-center justify-content-center emergency_bg_2 overlay_skyblue">
                        <div class="info">
                            <h3>Solicite atención en línea</h3>
                            <p>Estima el temperamento del espíritu también di adiós.</p>
                        </div>
                        <div class="info_button">
                            <a href="#" class="boxed-btn3-white">Solicitar</a>
